...
fn do_compress(input: &str, output: &str, method: Method, stats: bool) {
    {
        ...
        let mut out = match method {
            ...
            Method::WittenArith => {
                witten_arith::compress(BufReader::new(inf), BufWriter::new(outf)).unwrap()
            },
            Method::Lzw => {
...
fn do_decompress(input: &str, output: &str, method: Method, _stats: bool) {
    ...
    let mut out = match method {
        ...
        Method::WittenArith => {
            witten_arith::decompress(BufReader::new(inf), BufWriter::new(outf)).unwrap()
        },
        Method::Lzw => {
...
fn do_inspect(input: &str, method: Method) {
    ...
    match method {
        ...
        Method::WittenArith => {
            println!("inspect mode not supported for Witten arithmetic encoder");
        },
        Method::Lzw => {
